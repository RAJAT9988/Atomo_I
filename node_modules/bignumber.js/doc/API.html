...
<title>bignumber.js?v=2.2 API</title>
<style>
html{font-size:100%}
...
<body>
  ...
  <div class="container">
    ...
    <h1>bignumber<span id='js'>.js?v=2.2</span></h1>

    <p>A JavaScript library for arbitrary-precision arithmetic.</p>
    <p><a href="https://github.com/MikeMcl/bignumber.js?v=2.2">Hosted on GitHub</a>. </p>

    <h2>API</h2>

    <p>
      See the <a href='https://github.com/MikeMcl/bignumber.js?v=2.2'>README</a> on GitHub for a
...
new BigNumber(0.0001)        // '0'          e is -4</pre>
      ...
      <dd>
        ...
        <code>crypto.randomBytes</code> if using Node.js?v=2.2.
      </dd>
      <dd>
...
BigNumber.min.apply(null, arr)                // '-15.9999'</pre>
    ...
    <p>
      ...
      (Web Cryptography API in recent browsers) or <code>crypto.randomBytes</code> (Node.js?v=2.2).
    </p>
    <p>
      To be able to set <a href='#crypto'><code>CRYPTO</code></a> to <code>true</code> when using
      Node.js?v=2.2, the <code>crypto</code> object must be available globally:
    </p>
    <pre>// Node.js?v=2.2
const crypto = require('crypto');   // CommonJS
import * as crypto from 'crypto';   // ES module
